    ...
    public class Program
    {
        public static void Main()
        {
            ...
            Regex regexIpv6 = new Regex(
                ...
                "^(:(((:([0-9a-fA-F]){1,4}){1,7})|:))$");
            Regex regexIpv4 = new Regex("(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9]?)\\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9]?)\\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9]?)\\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9]?)$");
